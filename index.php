		...
		?>
			...
			<div id="banner-wrapper">
				<section id="banner">
					...
					<span class="byline">It has been much too long since my site has gotten a facelift. Until then, you can view my portfolio site.</span>
					<a href="http://jeffhegeman.info/" class="button">Portfolio</a>
				</section>
			</div>
		<!-- /Banner -->
