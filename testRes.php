...
<html>
	<head>
		<title>Hegeman, Jeffrey Resume</title>
	...
	<body class="homepage">
		...
		<!-- Header -->
			<header id="header">
				<div class="logo">
					<div>
						<h1><a href="#" id="logo">Jeffrey </a></h1>
						<span class="byline">R.</span>						
						<h1><a href="#" id="logo">Hegeman </a></h1>
					</div>
				</div>
			</header>
		<!-- /Header -->
		...
		<!-- Banner -->
			<div id="banner-wrapper">
				<section id="banner">
					...
					<span class="byline">PHP | MS SQL | JAVA | MySQL | ASP.net | Visual Basic | JavaScript</span>
